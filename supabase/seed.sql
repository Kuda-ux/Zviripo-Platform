...
begin
  ...
  insert into public.products (id, category_id, name, description, brand, created_by) values
    ('p0000000-0000-4000-8000-000000000001', 'ca000000-0000-4000-8000-000000000001',
     'Roller Meal 10kg', 'Refined maize meal, staple for sadza. Milled this week.', 'National Foods', owner),
    ('p0000000-0000-4000-8000-000000000002', 'ca000000-0000-4000-8000-000000000001',
     'Cooking Oil 2L', 'Pure vegetable cooking oil. Family size.', 'Roil', owner),
    ('p0000000-0000-4000-8000-000000000003', 'ca000000-0000-4000-8000-000000000001',
     'Sugar 2kg', 'White granulated sugar.', 'Huletts', owner),
    ('p0000000-0000-4000-8000-000000000004', 'ca000000-0000-4000-8000-000000000001',
     'Rice 2kg', 'Long grain white rice.', 'Mahatma', owner),
    ('p0000000-0000-4000-8000-000000000005', 'ca000000-0000-4000-8000-000000000001',
     'Mazoe Orange 2L', 'The original orange crush cordial.', 'Mazoe', owner),
    ('p0000000-0000-4000-8000-000000000006', 'ca000000-0000-4000-8000-000000000006',
     'Laundry Soap Bar', 'Blue bar soap, 500g. Washes clean.', 'Boom', owner),
    ('p0000000-0000-4000-8000-000000000007', 'ca000000-0000-4000-8000-000000000006',
     'Candles (pack of 6)', 'Reliable light during load shedding.', null, owner),
    ('p0000000-0000-4000-8000-000000000008', 'ca000000-0000-4000-8000-000000000001',
     'EcoCash Airtime $5', 'Instant airtime top-up for any Econet line.', 'Econet', owner),
    ('p0000000-0000-4000-8000-000000000009', 'ca000000-0000-4000-8000-000000000002',
     'Fresh Tomatoes 1kg', 'Grade A tomatoes, delivered this morning.', null, owner),
    ('p0000000-0000-4000-8000-000000000010', 'ca000000-0000-4000-8000-000000000002',
     'Rape Bunch', 'Fresh leafy rape, cut today.', null, owner),
    ('p0000000-0000-4000-8000-000000000011', 'ca000000-0000-4000-8000-000000000002',
     'Onions 1kg', 'Firm brown onions, keeps well.', null, owner),
    ('p0000000-0000-4000-8000-000000000012', 'ca000000-0000-4000-8000-000000000002',
     'Bananas 1kg', 'Sweet ripe bananas.', null, owner),
    ('p0000000-0000-4000-8000-000000000013', 'ca000000-0000-4000-8000-000000000003',
     'Samsung Galaxy A15', '128GB, dual SIM, 5000mAh battery. Boxed with charger and 12-month warranty.', 'Samsung', owner),
    ('p0000000-0000-4000-8000-000000000014', 'ca000000-0000-4000-8000-000000000003',
     'itel A50', '64GB Android Go phone. Great battery life.', 'itel', owner),
    ('p0000000-0000-4000-8000-000000000015', 'ca000000-0000-4000-8000-000000000003',
     'Bluetooth Earphones', 'Wireless earbuds with charging case.', null, owner),
    ('p0000000-0000-4000-8000-000000000016', 'ca000000-0000-4000-8000-000000000003',
     'Solar Charger 20W', 'Panel + power bank combo. Charge phones off-grid.', null, owner),
    ('p0000000-0000-4000-8000-000000000017', 'ca000000-0000-4000-8000-000000000004',
     'Men''s Denim Jeans', 'Straight fit, sizes 30–40.', null, owner),
    ('p0000000-0000-4000-8000-000000000018', 'ca000000-0000-4000-8000-000000000004',
     'School Shirt (White)', 'Boys and girls sizes. Hard-wearing fabric.', null, owner),
    ('p0000000-0000-4000-8000-000000000019', 'ca000000-0000-4000-8000-000000000004',
     'Ladies Summer Dress', 'Ankara print, sizes S–XL.', null, owner),
    ('p0000000-0000-4000-8000-000000000020', 'ca000000-0000-4000-8000-000000000005',
     'PPC Cement 50kg', 'SureBuild 42.5N general purpose cement.', 'PPC', owner),
    ('p0000000-0000-4000-8000-000000000021', 'ca000000-0000-4000-8000-000000000005',
     'Common Bricks (each)', 'Standard clay commons. Bulk discounts over 500.', null, owner),
    ('p0000000-0000-4000-8000-000000000022', 'ca000000-0000-4000-8000-000000000005',
     'Roofing Sheet 3m', 'IBR galvanised sheet, 0.47mm.', null, owner),
    ('p0000000-0000-4000-8000-000000000023', 'ca000000-0000-4000-8000-000000000005',
     'Claw Hammer 500g', 'Steel shaft, rubber grip.', null, owner),
    ('p0000000-0000-4000-8000-000000000024', 'ca000000-0000-4000-8000-000000000007',
     'Petroleum Jelly 250ml', 'Skin protection, household essential.', 'Vaseline', owner),
    ('p0000000-0000-4000-8000-000000000025', 'ca000000-0000-4000-8000-000000000001',
  ...
  values
    ...
    ('c0000000-0000-4000-8000-000000000001', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000001', 'RM10',   850, 'USD', true),
    ('c0000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000002', 'CO2L',   420, 'USD', true),
    ('c0000000-0000-4000-8000-000000000003', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000003', 'SUG2',   280, 'USD', true),
    ('c0000000-0000-4000-8000-000000000004', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000004', 'RICE2',  320, 'USD', true),
    ('c0000000-0000-4000-8000-000000000005', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000005', 'MAZ2L',  260, 'USD', true),
    ('c0000000-0000-4000-8000-000000000006', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000006', 'SOAP',    90, 'USD', true),
    ('c0000000-0000-4000-8000-000000000007', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000007', 'CAND6',  150, 'USD', true),
    ('c0000000-0000-4000-8000-000000000008', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000008', 'AIR5',   500, 'USD', true),
    ('c0000000-0000-4000-8000-000000000009', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000024', 'PJ250',  210, 'USD', true),
    ('c0000000-0000-4000-8000-000000000010', 'b0000000-0000-4000-8000-000000000001', 'p0000000-0000-4000-8000-000000000025', 'MAPUTI',  50, 'USD', true),
    -- Musika Fresh Produce
    ('c0000000-0000-4000-8000-000000000011', 'b0000000-0000-4000-8000-000000000002', 'p0000000-0000-4000-8000-000000000009', 'TOM1K',  120, 'USD', true),
    ('c0000000-0000-4000-8000-000000000012', 'b0000000-0000-4000-8000-000000000002', 'p0000000-0000-4000-8000-000000000010', 'RAPE',    50, 'USD', true),
    ('c0000000-0000-4000-8000-000000000013', 'b0000000-0000-4000-8000-000000000002', 'p0000000-0000-4000-8000-000000000011', 'ONI1K',  150, 'USD', true),
    ('c0000000-0000-4000-8000-000000000014', 'b0000000-0000-4000-8000-000000000002', 'p0000000-0000-4000-8000-000000000012', 'BAN1K',  100, 'USD', true),
    -- TechPoint Mobile
    ('c0000000-0000-4000-8000-000000000015', 'b0000000-0000-4000-8000-000000000003', 'p0000000-0000-4000-8000-000000000013', 'A15',  16500, 'USD', true),
    ('c0000000-0000-4000-8000-000000000016', 'b0000000-0000-4000-8000-000000000003', 'p0000000-0000-4000-8000-000000000014', 'ITELA50', 5900, 'USD', true),
    ('c0000000-0000-4000-8000-000000000017', 'b0000000-0000-4000-8000-000000000003', 'p0000000-0000-4000-8000-000000000015', 'EARBUD',  800, 'USD', true),
    ('c0000000-0000-4000-8000-000000000018', 'b0000000-0000-4000-8000-000000000003', 'p0000000-0000-4000-8000-000000000016', 'SOLAR20', 2500, 'USD', true),
    -- Ruvheneko Fashions
    ('c0000000-0000-4000-8000-000000000019', 'b0000000-0000-4000-8000-000000000004', 'p0000000-0000-4000-8000-000000000017', 'JEANS', 1200, 'USD', true),
    ('c0000000-0000-4000-8000-000000000020', 'b0000000-0000-4000-8000-000000000004', 'p0000000-0000-4000-8000-000000000018', 'SCHSHIRT', 600, 'USD', true),
    ('c0000000-0000-4000-8000-000000000021', 'b0000000-0000-4000-8000-000000000004', 'p0000000-0000-4000-8000-000000000019', 'DRESS', 1500, 'USD', true),
    -- DuraBuild Hardware (brick unlisted on purpose — shows merchant-only stock)
    ('c0000000-0000-4000-8000-000000000022', 'b0000000-0000-4000-8000-000000000005', 'p0000000-0000-4000-8000-000000000020', 'CEM50', 1250, 'USD', true),
    ('c0000000-0000-4000-8000-000000000023', 'b0000000-0000-4000-8000-000000000005', 'p0000000-0000-4000-8000-000000000021', 'BRICK',   35, 'USD', false),
    ('c0000000-0000-4000-8000-000000000024', 'b0000000-0000-4000-8000-000000000005', 'p0000000-0000-4000-8000-000000000022', 'IBR3M', 2200, 'USD', true),
    ('c0000000-0000-4000-8000-000000000025', 'b0000000-0000-4000-8000-000000000005', 'p0000000-0000-4000-8000-000000000023', 'HAMMER', 700, 'USD', true)
  on conflict (id) do nothing;
